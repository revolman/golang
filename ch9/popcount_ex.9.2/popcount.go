// Упражнение 9.2 - использование sync.Once
...
// init пришлось убрать и перенести в анонимную функцию из-за условий задачи.
// Можно было переименовать init(). Это служебное имя функции.
...
func PopCount(x uint64) int {
	...
	// разовый вызов инициализации таблицы поиска
